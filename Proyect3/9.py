...
while True:
    ...
    xd = Segmentation(cv_image_with_text)

    # Mostrar el resultado de la segmentación en la ventana de Pygame
    xd_surface = Cv2_to_pygame(xd)
    pygame_surface.blit(xd_surface, (0, 0))
